//#ifndef CPPTEST_HEAVYTESTS_H
//#define CPPTEST_HEAVYTESTS_H
...
void TestHeavyLoad(){
    LOG_DURATION("TestHeavyLoad");
    ifstream docs("docs.txt");
    ifstream query("query.txt");
    if(docs.is_open() && query.is_open()){
        SearchServer srv;
        srv.UpdateDocumentBase(docs);
        ostringstream queries_output;
        srv.AddQueriesStream(query, queries_output);
        const string result = queries_output.str();
        cout<<"TestHeavyLoad is works"<<endl;
    } else{
...
void TestMidLoad(){
    LOG_DURATION("TestMidLoad");
    ifstream docs("docs-mid.txt");
